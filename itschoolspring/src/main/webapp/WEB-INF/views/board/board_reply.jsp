...
<body>
	<div class="container text-center">
	  ...
	  <form class="form-horizontal" id="insert_form" action="boardReplySave" name="insert_form"  method="post" role="form" data-parsley-validate="ture">
		    ...
		    <div class="form-group" >
	     	...
	     	<div class="form-group" style="text-align:center">
				...
				<div class="col-sm-7">
					<input type="text" autofocus class="form-control" value="[답글] ${board.b_title}" id="b_title" name="b_title" placeholder="">
				</div>
		    </div>
			<div class="form-group" style="text-align:center">
			...
			<div class="row">
			 	<div class="col-sm-6" style="float:right;">
			 		...
			 		<c:if test="${sessionid == 'admin'|| sessionid == board.b_id}">
						<button type="submit" class="btn btn-info" id="save" name="save">저장</button>
						<button type="button" class="btn btn-danger" onclick="location.href='index'"  id="save" name="save">취소</button>
					</c:if>
