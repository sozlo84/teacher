...
<form action="boardDelete" method="post">
	<div class="contatiner" style="border:3px solid red">
		...
		<div class="row" style="border:1px solid yellow">
			<div class="col-md-offset-4 col-md-4 resultPage" style="border:1px solid blue">Delete Page</div>		
		</div>
		...
		<div class="row" style="border:7px solid navy">
				...
				<button type="button" onclick="location.href='memberList'" class="col-md-2 btn btn-success resultButton" style="border:5px solid blue">취소</button>
		</div>
	</div>
