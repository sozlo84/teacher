...
<div class="container text-center">
  ...
  <form class="form-horizontal" id="salarycreate_form" action="salaryCreate" name="insert_form"  method="post" role="form" data-parsley-validate="ture">
...
<!-- 					<span class="input-group-addon"><i class="fa fa-male" aria-hidden="true"></i></span> -->
				...
				<div class="col-md-offset-2 input-group" align="center">
			        <button id="create" type="button" class="btn btn-default">생성</button>
			        <span>&nbsp;&nbsp;</span>
